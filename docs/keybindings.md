...
| 6 | `<backtab>` | `shift+tab` | `magit-section-cycle-global` | binding | ui | `magit-section-mode-map` | `lisp/magit-section.el:470 (magit-section-mode-map)` | `partial` | registered handler |
| 7 | `^` | `^` | `magit-section-up` | binding | ui | `magit-section-mode-map` | `lisp/magit-section.el:471 (magit-section-mode-map)` | `partial` | registered handler |
...
| 10 | `M-p` | `alt+p` | `magit-section-backward-sibling` | binding | ui | `magit-section-mode-map` | `lisp/magit-section.el:474 (magit-section-mode-map)` | `partial` | registered handler |
| 11 | `M-n` | `alt+n` | `magit-section-forward-sibling` | binding | ui | `magit-section-mode-map` | `lisp/magit-section.el:475 (magit-section-mode-map)` | `partial` | registered handler |
...
| 15 | `4` | `4` | `magit-section-show-level-4` | binding | ui | `magit-section-mode-map` | `lisp/magit-section.el:479 (magit-section-mode-map)` | `partial` | registered handler |
| 16 | `M-1` | `alt+1` | `magit-section-show-level-1-all` | binding | ui | `magit-section-mode-map` | `lisp/magit-section.el:480 (magit-section-mode-map)` | `partial` | registered handler |
| 17 | `M-2` | `alt+2` | `magit-section-show-level-2-all` | binding | ui | `magit-section-mode-map` | `lisp/magit-section.el:481 (magit-section-mode-map)` | `partial` | registered handler |
| 18 | `M-3` | `alt+3` | `magit-section-show-level-3-all` | binding | ui | `magit-section-mode-map` | `lisp/magit-section.el:482 (magit-section-mode-map)` | `partial` | registered handler |
| 19 | `M-4` | `alt+4` | `magit-section-show-level-4-all` | binding | ui | `magit-section-mode-map` | `lisp/magit-section.el:483 (magit-section-mode-map)` | `partial` | registered handler |
| 20 | `C-<return>` | `ctrl+enter` | `magit-visit-thing` | binding | ui | `magit-mode-map` | `lisp/magit-mode.el:354 (magit-mode-map)` | `partial` | registered handler |
| 21 | `RET` | `enter` | `magit-visit-thing` | binding | ui | `magit-mode-map` | `lisp/magit-mode.el:355 (magit-mode-map)` | `partial` | registered handler |
...
| 23 | `M-<tab>` | `alt+tab` | `magit-section-cycle-diffs` | binding | ui | `magit-mode-map` | `lisp/magit-mode.el:357 (magit-mode-map)` | `adapted` | registered handler |
...
| 26 | `DEL` | `backspace` | `magit-diff-show-or-scroll-down` | binding | ui | `magit-mode-map` | `lisp/magit-mode.el:360 (magit-mode-map)` | `partial` | registered handler |
| 27 | `+` | `+` | `magit-diff-more-context` | binding | ui | `magit-mode-map` | `lisp/magit-mode.el:361 (magit-mode-map)` | `partial` | registered handler |
| 28 | `-` | `-` | `magit-diff-less-context` | binding | ui | `magit-mode-map` | `lisp/magit-mode.el:362 (magit-mode-map)` | `partial` | registered handler |
| 29 | `0` | `0` | `magit-diff-default-context` | binding | ui | `magit-mode-map` | `lisp/magit-mode.el:363 (magit-mode-map)` | `partial` | registered handler |
...
| 46 | `H` | `H` | `magit-describe-section` | binding | ui | `magit-mode-map` | `lisp/magit-mode.el:378 (magit-mode-map)` | `partial` | registered handler |
...
| 49 | `J` | `J` | `magit-display-repository-buffer` | binding | ui | `magit-mode-map` | `lisp/magit-mode.el:383 (magit-mode-map)` | `partial` | registered handler |
...
| `Z` | `magit-snapshot-both` | **suffix** | Snapshot |  | `partial` | non-destructive tracked index/worktree snapshot stored as a stash entry |
...
| Key | Command | Kind | Group | Conditions | Classification | Current status |
|---|---|---|---|---|---|---|
| `z ` | `magit-jump-to-stashes` | **suffix** | Jump to | if: #[nil ((memq 'magit-insert-stashes (symbol-value (intern (format "%s-sections-hook" (substring (symbol-name major-mode) 0 -5)))))) (t)]; inapt-if-not: #[nil ((magit-get-section (cons (cons 'stashes "refs/stash") (magit-section-ident magit-root-section)))) (t)] | `partial` | TUI workflow handler (startup-validated) |
...
| `n ` | `magit-jump-to-untracked` | **suffix** | Jump to | if: #[nil ((memq 'magit-insert-untracked-files (symbol-value (intern (format "%s-sections-hook" (substring (symbol-name major-mode) 0 -5)))))) (t)]; inapt-if-not: #[nil ((magit-get-section (cons (cons 'untracked nil) (magit-section-ident magit-root-section)))) (t)] | `partial` | TUI workflow handler (startup-validated) |
